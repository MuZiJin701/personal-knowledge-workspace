...
这里提供主题级导航，不维护逐文件清单。新增长期主题时补充一行；主题确实需要二级导航时，再在主题内创建 `README.md`。
...
- [Windows Theming](knowledge/windows-theming/)：Windows 主题统一设置与排障记录。

工作流配置位于 [`docs/agents/`](docs/agents/)；领域术语入口见 [`CONTEXT-MAP.md`](CONTEXT-MAP.md)。
